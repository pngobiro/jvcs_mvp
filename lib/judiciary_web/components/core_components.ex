defmodule JudiciaryWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: JudiciaryWeb.Gettext
  ...
  def table(assigns) do
    ...
    ~H"""
    <div class={["overflow-x-auto w-full", @class]}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JudiciaryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JudiciaryWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def modal(assigns) do
    ~H"""
    <div id={@id} phx-mounted={@show && show_modal(@id)} phx-remove={hide_modal(@id)} data-cancel={@on_cancel} class="relative z-50 hidden">
